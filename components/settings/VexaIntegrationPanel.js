    ...
    <div className="bg-surface border border-subtle rounded-2xl p-6 shadow-xl animate-fade-in space-y-6">
      ...
      <div className="flex items-center justify-end gap-3 pt-2 border-t border-subtle">
        ...
        <button
          ...
          disabled={!canEdit || saving}
          onClick={handleSave}
          className="px-4 py-2 rounded-xl text-sm bg-accent-strong text-white hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2"
        >

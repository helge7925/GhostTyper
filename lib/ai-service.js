...
export async function translateTextSegments(segments, targetLanguage, sourceLanguage = 'auto', apiKey, model = null) {
  const usedModel = model || TRANSLATION_MODEL;
...
export async function optimizeText(text, preset, customInstruction = '', apiKey, model = null) {
  const usedModel = model || TRANSLATION_MODEL;

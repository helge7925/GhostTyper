...
export async function checkpointMeetingStt({
  ...
  const meetingModel = openrouter.defaultModels.liveTranscription;
  if (!openrouter.apiKey || !meetingModel) {
    throw Object.assign(new Error('OpenRouter live transcription is not configured.'), { code: 'MODEL_UNAVAILABLE' });
  }

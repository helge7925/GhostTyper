...
// Curated UI offering; ids match Cortecs' API model ids exactly
// (see cortecs.ai/detailedServerlessView/<id>). The labels carry a short
// 2-3-adjective characterization for non-technical users and are rendered
// by every chat-model dropdown — edit here, not in the pages.
export const CHAT_MODEL_OPTIONS = [
  { value: 'deepseek-v4-pro', label: 'DeepSeek V4 Pro – sehr intelligent, langer Kontext (Standard)' },
  { value: 'deepseek-v4-flash', label: 'DeepSeek V4 Flash – sehr günstig, sehr schnell, einfache Aufgaben' },
  { value: 'kimi-k2.6', label: 'Kimi K2.6 – intelligent, vielseitig, ausgewogen' },
  { value: 'kimi-k2.7-code', label: 'Kimi K2.7 Code – auf Code spezialisiert, präzise, strukturiert' },
  { value: 'minimax-m3', label: 'MiniMax M3 – kosteneffizient, langer Kontext, mittlere Intelligenz' },
];

export const CHAT_MODELS = CHAT_MODEL_OPTIONS.map((option) => option.value);
...
export const DEFAULT_CORTECS_BASE_URL = 'https://api.cortecs.ai/v1';
...
export const STATUS_LABELS = {
  ...
  [STATUS.BUDGET_STOPPED]: 'Durch Budget gestoppt',
  [STATUS.ERROR]: 'Fehler',
};
...
const ALLOWED_DEFAULT_TEMPLATES = ['generic', 'meeting', 'action_items'];
const ALLOWED_ANALYSIS_TEMPLATES = ['generic', 'meeting', 'action_items', 'data_table', 'aufmass'];

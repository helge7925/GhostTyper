...
import { extractClientIp } from './network-guard.js';
...
// Single source of truth for client-IP extraction lives in
// `lib/network-guard.js`. It only honours forwarded headers when
// the immediate socket peer is itself in a private network (i.e.
// a trusted reverse proxy) — that's how we avoid X-Forwarded-For
// spoofing from a direct host-port connection.

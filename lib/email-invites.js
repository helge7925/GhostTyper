import { logInfo, logError } from './observability.js';
...
export function sanitizeInviteFromName(value) {
  return String(value || '')
    .replace(/[\x00-\x1f\x7f]/g, '')
    .slice(0, 80);
}

const FROM_NAME = sanitizeInviteFromName(process.env.INVITE_FROM_NAME || 'GhostTyper') || 'GhostTyper';

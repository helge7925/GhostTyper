...
const migrations = `
  ...
  -- Documents explicitly attached to a conversation as retrieval context, in
  -- addition to the conversation's origin context_ref_id. (Knowledge-base
  -- attachments are a later item; document-only for now.)

...
const migrations = `
  ...
  ALTER TABLE transcriptions DROP CONSTRAINT IF EXISTS transcriptions_folder_id_fkey;
  ALTER TABLE transcriptions DROP CONSTRAINT IF EXISTS fk_transcriptions_folder_owner;

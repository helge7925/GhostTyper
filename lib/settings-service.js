...
export async function resolveCortecsConfig({ userId, organizationId } = {}) {
  const defaults = {
    ...
    chatModel: resolveChatModel(process.env.CORTECS_CHAT_MODEL, null) || DEFAULT_CHAT_MODEL,
    transcriptionModel: resolveTranscriptionModel(process.env.CORTECS_TRANSCRIPTION_MODEL, null) || DEFAULT_TRANSCRIPTION_MODEL,
    ...
    try {
      ...
      if (integration.enabled) {
        ...
        return {
          ...
          chatModel: resolveChatModel(cfg.defaultChatModel, null) || defaults.chatModel,
          transcriptionModel: resolveTranscriptionModel(cfg.defaultTranscriptionModel, null) || defaults.transcriptionModel,

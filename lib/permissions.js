...
export const PERMISSIONS = {
  ...
  // Dateien / documents
  'document.read':        ['viewer', 'auditor', 'member', 'admin', 'owner'],
  'document.write':       ['member', 'admin', 'owner'],
  'document.delete':      ['admin', 'owner'],

  // Workspace Wissen / knowledge bases
  'knowledge.read':       ['viewer', 'auditor', 'member', 'admin', 'owner'],
  'knowledge.write':      ['member', 'admin', 'owner'],
  'knowledge.delete':     ['admin', 'owner'],

  // Aufgaben / extracted tasks
  'task.read':            ['viewer', 'auditor', 'member', 'admin', 'owner'],
  'task.write':           ['member', 'admin', 'owner'],
  'task.delete':          ['admin', 'owner'],

  // Chat
  'chat.read':            ['viewer', 'auditor', 'member', 'admin', 'owner'],
  'chat.write':           ['member', 'admin', 'owner'],
  'chat.delete':          ['admin', 'owner'],

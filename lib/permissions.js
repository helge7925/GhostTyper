...
export const PERMISSIONS = {
  ...
  // Budget and provider-cost governance
  'budget.read.self':     ['viewer', 'auditor', 'member', 'admin', 'owner'],
  'budget.read.org':      ['admin', 'owner'],
  'budget.manage':        ['admin', 'owner'],
  'paid.execute':         ['member', 'admin', 'owner'],
  'pricing.override':     ['owner'],
